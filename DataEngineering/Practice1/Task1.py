...
def read_file():
    with open("C:/Users/Григорий/PycharmProjects/pythonProject2/DataEngineering/Practice1/first_task.txt", encoding="utf_8") as file:
...
def write_to_file(stat):
    with open("first_task_result_freq.txt", "w", encoding="utf_8") as file:
        for key, val in stat:
            file.write(f'{key}:{val}\n')


def write_avg_to_file(res):
    with open("first_task_result_avg.txt", "w", encoding="utf_8") as file:
        file.write(f'{res}')
