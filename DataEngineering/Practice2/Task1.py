...
matrix = np.load("C:/Users/Григорий/PycharmProjects/pythonProject2/DataEngineering/Practice2/first_task.npy")
...
with open("first_task.json", 'w', encoding='utf-8') as file:
